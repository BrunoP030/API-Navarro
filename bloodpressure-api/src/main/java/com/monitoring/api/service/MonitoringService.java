...
public class MonitoringService {
    ...
    // Busca dados por dispositivo específico
    public List<BloodPressureData> getBloodPressureByPatientAndDevice(String patientId, String deviceId) {
        return bloodPressureRepository.findByPatientIdAndDeviceId(patientId, deviceId);
    }
}